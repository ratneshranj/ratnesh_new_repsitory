# Updated as of Aug 05, 2022
# Install FROM UBUNTU IMAGE
FROM ubuntu:16.04

#Author of the Docker File
# MAINTAINER ratneshranj Note: MAINTAINER has been deprecated for LABEL, 
# LABEL is a key value pair 
LABEL "Maintainer"="ratneshranj"
...
# ADD a directory called docker-git-helloworld inside the UBUNTU IMAGE where you will be moving all of these files under this 
# DIRECTORY to
...
CMD ["java", "-cp", "/usr/local/docker-git-helloworld/target/docker-git-helloworld-0.0.1-SNAPSHOT-jar-with-dependencies.jar", "sample.HelloWorld"]